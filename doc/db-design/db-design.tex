  ...
  \maketitle
	\section{Entities}
		...
		\subsection{Content}
			...
			\end{itemize}
			\subsection{Reviews}
			Reviews are the way by which users rate their satisfaction with a particular piece of content. Reviews consist of the following attributes. 
			\begin{itemize}
	...
	\section{Relationships}
		\subsection{User Writes Reviews}
			A user (admin or regular) is the author of zero or many reviews.
		\subsection{Review Written for Content}
			A piece of content can obtain many reviews, but each review only belongs to one particular piece of content.
		...
		\subsection{User Reads Book}
			A user can read zero or many books, and a book may be read by zero or many users.
