...
\section{Functional Requirements}
	...
	\item	Order Search Results:
			...
			-User can order the search results based on release date or number of favorites. Default search behavior is based on the number of favorites a book has received

	\item	Filter Search Results:

			-User can filter the search results based on author, title, release date, publisher, or genre
	\item	Select Book:
