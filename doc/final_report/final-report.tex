...
\begin{itemize}
	...
	\item How to use 3-tier architecture with database systems, which includes:
		...
		\end{itemize}
	\item How to be an effective team leader by delegating responsibilities and enforcing deadlines so all team members, including myself, can accomplish the given task on time
	\item Transforming an E/R diagram into website functionalities
\end{itemize}
