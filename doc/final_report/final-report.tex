...
\subsubsection{Use Case: View Content Profile}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.33]{content-profile.png}
		\caption{client's perspective: viewing content profile}
	\end{figure}

	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.44]{content-profile-code.png}
...
\subsubsection{Use Case: Favorite Content}
...
\subsubsection{Use Case: Download Content}
